...
private:
  ...
  bool feedbackFresh(int motor_id) const;
  ...
  rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr dxl_stop_pub_;
  ...
  std::unordered_map<std::string, rclcpp::Time> joint_feedback_time_;
