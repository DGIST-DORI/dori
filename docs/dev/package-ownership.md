...
| `stt_pkg` | `dori_hri_stt` | HRI speech input | Auxiliary HRI package for wake-word detection, audio intake, and speech-to-text models/runtime dependencies. |
| `tts_pkg` | `dori_hri_tts` | HRI speech output | Auxiliary HRI package for speech synthesis, audio cues, playback, and audio assets. |
...
center.  `dori_hri_expression`, `dori_hri_stt`, and `dori_hri_tts` own their
